...
def _use_cutedsl_compressor(head_dim: int) -> bool:
    """Keep CuTeDSL warmup and dispatch on the same supported devices."""
    return head_dim == 512 and current_platform.is_cuda() and is_cutedsl_supported()
...
class DeepseekCompressor(nn.Module):
    ...
    def __init__(
        ...
        if vllm_config.kernel_config.enable_jit_warmup:
            ...
            if _use_cutedsl_compressor(self.head_dim):
